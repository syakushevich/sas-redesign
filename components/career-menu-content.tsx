// src/components/career-menu-content.tsx
import * as React from "react";
import Link from "next/link";
import { NavigationMenuContent } from "@/components/ui/navigation-menu";
import { careerNavGroups } from "@/config/site"; // Import the data

export function CareerMenuContent() {
  return (
